...
<Table>
  ...
  <tbody>
    ...
    <Table.Tr>
      ...
      <Table.Td>
        The full hostname URL of the Keycloak server, for example,`http://localhost:8085` or `https://my-keycloak.example.com`. 
...
Follow this [guide](/guides/manage-fed/add-realm-admin) to add a Realm admin for service accounts creation. Then, add the credentials to the `.env` file as `KeycloakAdmin__Username` and `KeycloakAdmin__Password`.
  ...
  <tbody>
    <Table.Tr>
      ...
      <Table.Td>
        ...
        [guide](/guides/manage-fed/add-realm-admin) to generate.
      </Table.Td>
    </Table.Tr>
  </tbody>
</Table>
...
<Table>
  ...
  <tbody>
    <Table.Tr>
      ...
      <Table.Td>
        The URL of the Submission Layer's Keycloak server, for example, https://submission-keycloak.example.com.
      </Table.Td>
    </Table.Tr>
    <Table.Tr>
      <Table.Td>`SubmissionS3ApiUrl`</Table.Td>
      <Table.Td>
        Where the S3 Submission Layer API is hosted. For example, https://s3-submission-api.example.com. This is required by TRE Agent to connect to the Submission Layer S3 server.
      </Table.Td>
    </Table.Tr>
    <Table.Tr>
    ...
    <Table.Tr>
      ...
      <Table.Td>
        The URL for the Submission Layer's UI's Keycloak redirect URL. For example, https://host-of-submission.example.com/.
      </Table.Td>
    </Table.Tr>
    <Table.Tr>
      <Table.Td>`KeycloakFullURL`</Table.Td>
      <Table.Td>
        The full hostname URL of the Keycloak server, for example, https://my-keycloak.example.com. Note: This is only used if you are using a local/internal Keycloak service defined in the `ServiceStack/compose-manifests/shared/auth.yml` file.
      </Table.Td>
    </Table.Tr>
  </tbody>
</Table>
...
- [Set up a new Project](/guides/manage-fed/setup-new-project)