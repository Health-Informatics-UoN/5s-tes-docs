...
3. Download the **Agent Onboarding Configuration** JSON file by clicking the top right corner button `Download Config`.
...
- The **Submission Layer** endpoint is valid reachable.
...
- [Approving Projects/Memberships](/guides/manage-tre/approvals)
- [Review & Approve Outputs](/guides/egress-approval/approve-outputs)
